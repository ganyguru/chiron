...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Layouts - Dark Header Brand</title>
	...
	<body class="container-fluid dark-header-brand">
		<div id="page-wrapper">
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Dark Header Brand Layout</h2>
								<p>There are two available methods to get the dark header brand layout.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
								...
								<h4>Dark Header Brand JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.darkHeaderBrand();</xmp></pre>
								<h4>Light Header Brand JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.lightHeaderBrand();</xmp></pre>
							</div>
							<div class="col-lg-12">
								<h3>Using Manual Method</h3>
								<p>Add the <code>.dark-header-Brand</code> class to the <code>body</code> element of the page.</p>
								<h4>Dark Header Brand HTML Code:</h4>
								<pre><xmp><body class="container-fluid dark-header-brand"></xmp></pre>
							</div>
						</div>
