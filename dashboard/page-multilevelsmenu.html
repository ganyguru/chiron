...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Multi Level Menu</title>
				...
				<section id="right-content-wrapper">
					<section class="page-header alternative-header">
						<ol class="breadcrumb">
							...
							<li>Dashboard</li>
							<li>Components</li>
							<li>Multilevels Side Menu</li>
						</ol>
						<div class="page-header_title">
							<h1>
								Multilevels Side Menu
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<p>The HTML structure is pretty simple: the side menu consists of a series of unordered lists nested one inside the other.</p>
							</div>
							<div class="col-lg-12">
								<h4>Example HTML Code:</h4>
								<div class="panel panel-default">
									<div class="panel-body">
										<pre><xmp><nav id="sidebar">
	<ul>
		<li>
			<a href="#">
				<span class="menu-item-ico"><i class="material-icons">dashboard</i></span>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Create a submenu</h2>
								<p></p>
							</div>
							<div class="col-lg-6">
								<h4>First Level Submenu Example HTML Code:</h4>
								<div class="panel panel-default">
									<div class="panel-body">
										<pre><xmp><li>
	<a href="">
	...
	<ul>
		...
		<li><a href="">Level 2-3</a></li>
							...
							<div class="col-lg-6">
								<h4>Second Level Submenu Example HTML Code:</h4>
								<div class="panel panel-default">
									<div class="panel-body">
										<pre><xmp><li>
