...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Notifications - Snackbar</title>
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<p>For performance reasons, the Snackbars are opt-in, meaning you must initialize them yourself.</p>
								<pre><xmp>$(function () {
	$.snackbar();
});</xmp></pre>
							</div>
							...
							<div class="col-lg-6">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="row">
											<div class="col-sm-6">
												<button id="btntest-snackbar1" class="btn btn-default btn-raised" type="button">Success Snackbar</button>
											</div>
											<div class="col-sm-6">
												<button id="btntest-snackbar2" class="btn btn-default btn-raised" type="button">Info Snackbar</button>
											</div>
											<div class="col-sm-6">
												<button id="btntest-snackbar3" class="btn btn-default btn-raised" type="button">Warning Snackbar</button>
											</div>
											<div class="col-sm-6">
												<button id="btntest-snackbar4" class="btn btn-default btn-raised" type="button">Danger Snackbar</button>
											</div>
										</div>
									</div>
								</div>
