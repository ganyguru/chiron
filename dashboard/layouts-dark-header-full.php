...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Layouts - Dark Header Full</title>
	...
	<body class="container-fluid dark-header">
		<div id="page-wrapper">
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Full Dark Header Layout</h2>
								<p>There are two available methods to get the full dark header layout.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
								...
								<h4>Full Dark Header JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.darkHeader();</xmp></pre>
								<h4>Full Light Header JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.lightHeader();</xmp></pre>
							</div>
							<div class="col-lg-12">
								<h3>Using Manual Method</h3>
								<p>Add the <code>.dark-header</code> class to the <code>body</code> element of the page.</p>
								<h4>Full Dark Header HTML Code:</h4>
								<pre><xmp><body class="container-fluid dark-header"></xmp></pre>
							</div>
						</div>
