...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
   <head>
		...
		<title>Bemat Admin v1 - Pagination</title>
	...
	<body class="container-fluid dark-sidebar dark-header-brand">
		<div id="page-wrapper">
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">				<section id="right-content-wrapper">
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Default pagination</h2>
	...
	<li>
		<a href="#" aria-label="Next">
			<span aria-hidden="true">&raquo;</span>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Disabled and active states</h2>
