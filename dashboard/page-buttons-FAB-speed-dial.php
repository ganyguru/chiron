...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Buttons - FAB Speed Dial</title>
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">FAB Speed Dial</h2>
								<p>You may supply a direction of <code>left</code>, <code>up</code>, <code>down</code> or <code>right</code> through the <code>data-direction</code> attribute, and an animation mode of <code>fling</code> or <code>scale</code> through the <code>data-mode</code> attribute.</p>
							</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="speed-dial-demo">
											<div id="demo-speed-dial" class="md-fab-speed-dial" data-toggle="speed-dial" data-mode="fling">
										...
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="radio"><label>
													<input class="radio radio-primary radio-up-fabspeeddial" type="radio" name="fab-direction" value="up" checked/>
													Up
												</label></div>
												<div class="radio"><label>
													<input class="radio radio-primary radio-down-fabspeeddial" type="radio" name="fab-direction" value="down" />
													Down
												</label></div>
												<div class="radio"><label>
													<input class="radio radio-primary radio-left-fabspeeddial" type="radio" name="fab-direction" value="left" />
													Left
												</label></div>
												<div class="radio"><label>
													<input class="radio radio-primary radio-right-fabspeeddial" type="radio" name="fab-direction" value="right" />
													Right
												</label></div>
											</div>
											<div class="col-sm-4">
												<h4>Open/Closed</h4>
												<div class="radio"><label>
													<input class="radio radio-primary radio-open-fabspeeddial" type="radio" name="fab-state" value="open" />
													Open
												</label></div>
												<div class="radio"><label>
													<input class="radio radio-primary radio-close-fabspeeddial" type="radio" name="fab-state" value="closed" checked />
													Closed
												</label></div>
											</div>
											<div class="col-sm-4">
												...
												<div class="radio"><label>
													<input class="radio radio-primary radio-fling-fabspeeddial" type="radio" name="fab-animation" value="fling" checked />
													Fling
												</label></div>
												<div class="radio"><label>
													<input class="radio radio-primary radio-scale-fabspeeddial" type="radio" name="fab-animation" value="scale" />
													Scale
												</label></div>
											</div>
										</div>
							...
							<div class="col-lg-12">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<pre><xmp><div class="md-fab-speed-dial" data-toggle="speed-dial" data-mode="fling">
	<div class="md-fab-trigger" aria-expanded="false" aria-haspopup="true">
		<button type="button" class="btn btn-floating-action btn-info"><i class="material-icons">menu</i></button>
	</div>
