...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Layouts - Dark Header Toolbar</title>
	...
	<body class="container-fluid dark-header-toolbar">
		<div id="page-wrapper">
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Dark Header Toolbar Layout</h2>
								<p>There are two available methods to get the dark header toolbar layout.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
								<h3>Using Bemat Theme API</h3>
								<p>Using the Bemat Admin Theme API, you can easily set the style you want.</p>
								<h4>Dark Header Toolbar JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.darkHeaderToolbar();</xmp></pre>
								<h4>Light Header Toolbar JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.lightHeaderToolbar();</xmp></pre>
							</div>
							<div class="col-lg-12">
								<h3>Using Manual Method</h3>
								<p>Add the <code>.dark-header-toolbar</code> class to the <code>body</code> element of the page.</p>
								<h4>Dark Header Toolbar HTML Code:</h4>
								<pre><xmp><body class="container-fluid dark-header-toolbar"></xmp></pre>
							</div>
						</div>
