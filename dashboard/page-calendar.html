...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Calendar</title>
	...
	<body id="page-calendar" class="container-fluid  dark-header-brand dark-sidebar">
		<div id="page-wrapper">
		...
		<script src="js/bemat-admin-calendar.min.js"></script>
