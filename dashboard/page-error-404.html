...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin - Error 404</title>
	...
	<body id="page-error" class="container-fluid ">
		...
		<div id="error-box">
			<div class="error-box-wrapper">
				<div class="error-code display-4">404</div>
				<div class="error-message display-2">Page Not Found</div>
				<div class="error-submessage">Sorry! The page you're looking for cannot be found.</div>
