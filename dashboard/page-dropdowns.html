...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Dropdowns</title>
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Basic Dropdown</h2>
							</div>
							<div class="col-lg-6">
								<h4>Examples:</h4>
...
<div class="dropdown">
	...
	<ul class="dropdown-menu">
		...
		<li><a href="#"><i class="material-icons">exit_to_app</i> Log Out</a></li>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Dropdown Position</h2>
							</div>
							<div class="col-lg-12">
								<h3>Right Direction</h3>
								<p>To right-align the dropdown, add the <code>.dropdown-menu-right</code> class to the element with <code>.dropdown-menu</code>:</p>
							</div>
							<div class="col-lg-6">
								<h4>Examples:</h4>
								<div class="panel panel-default">
...
<div class="dropdown">
	...
	<ul class="dropdown-menu dropdown-menu-right">
		...
		<li><a href="#"><i class="material-icons">exit_to_app</i> Log Out</a></li>
							...
							<div class="col-lg-12">
								<h3>Up Direction </h3>
								<p>If you want the dropdown menu to expand upwards instead of downwards, change the &lt;div&gt; element with <code>class="dropdown"</code> to <code>class="dropup"</code></p>
							</div>
							<div class="col-lg-6">
								<h4>Examples:</h4>
								<div class="panel panel-default">
...
<div class="dropup">
	...
	<ul class="dropdown-menu">
		...
		<li><a href="#"><i class="material-icons">exit_to_app</i> Log Out</a></li>
							...
							<div class="col-lg-12">
								<h3>Up Direction Right Direction</h3>
								<p>To right-align the dropdown, add the <code>.dropdown-menu-right</code> class to the element with <code>.dropdown-menu</code></p>
							</div>
							<div class="col-lg-6">
								<h4>Examples:</h4>
