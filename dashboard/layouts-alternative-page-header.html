...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Layouts - Alternative Page Header</title>
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Alternative Page Header Layout Example</h2>
								<p>To get the alternative page header, add the <code>.alternative-header</code> class to the <code>.page-header</code> section of the page.</p>
								<p>This page shows up the alternative page header.</p>
							</div>
						</div>
