...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Layouts - Dark Sidebar</title>
	...
	<body class="container-fluid dark-sidebar">
		<div id="page-wrapper">
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Dark Sidebar Layout</h2>
								<p>There are two available methods to get the dark sidebar layout.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
								...
								<h4>Dark Sidebar JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.darkSidebar();</xmp></pre>
								<h4>Light Sidebar JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.lightSidebar();</xmp></pre>
							</div>
							<div class="col-lg-12">
								<h3>Using Manual Method</h3>
								<p>Add the <code>.dark-sidebar</code> class to the <code>body</code> element of the page.</p>
								<h4>Dark Sidebar HTML Code:</h4>
								<pre><xmp><body class="container-fluid dark-sidebar"></xmp></pre>
							</div>
						</div>
