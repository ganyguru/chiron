...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Progress Indicators - Progress bars</title>
  ...
  <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
    <span class="sr-only">60% Complete</span>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">With label</h2>
  ...
  <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
    60%
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Contextual Alternatives</h2>
...
<div class="progress">
  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
    <span class="sr-only">80% Complete (danger)</span>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Striped</h2>
...
<div class="progress">
  <div class="progress-bar progress-bar-danger progress-bar-striped" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
    <span class="sr-only">80% Complete (danger)</span>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Animated</h2>
  ...
  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 45%">
    <span class="sr-only">45% Complete</span>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Stacked</h2>
