...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Layouts - Collapsed Sidebar</title>
	...
	<body class="container-fluid sidebar-collapsed">
		<div id="page-wrapper">
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Collapsed Sidebar Layout</h2>
								<p>There are two available methods to get the collapsed sidebar layout.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-12">
								...
								<h4>Collapsed Sidebar JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.collapsedSidebar();</xmp></pre>
								<h4>Normal Sidebar JAVASCRIPT Code:</h4>
								<pre><xmp>bematadmin.App.theme.normalSidebar();</xmp></pre>
							</div>
							<div class="col-lg-12">
								<h3>Using Manual Method</h3>
								<p>Add the <code>.sidebar-collapsed</code> class to the <code>body</code> element of the page.</p>
								<h4>Dark Header Brand HTML Code:</h4>
								<pre><xmp><body class="container-fluid sidebar-collapsed"></xmp></pre>
							</div>
						</div>
