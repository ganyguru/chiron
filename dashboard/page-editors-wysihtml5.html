...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Editors - wysihtml5 Editor</title>
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Basic Mode</h2>
								<p></p>
							</div>
						</div>
							...
							<div class="col-lg-12">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<textarea id="wysihtml5" class="height-6" placeholder="Enter text here">
											<h1>This is WYSIHTML5 Editor</h1>
