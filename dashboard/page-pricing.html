...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin v1 - Pricing Tables</title>
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Style 1</h2>
							</div>
						</div>
										...
										<div class="col-sm-4">
											<div class="plan">
												...
												<ul class="features-list">
													...
													<li><strong>Limited</strong> Support</li>
												</ul>
												<div class="price layout-align-center-start layout-row">
													<div class="currency">$</div>
													<div class="layout-align-center-end layout-row">
														<div class="value">8</div>
														<div class="period">/ month</div>
													</div>
												</div>
												<button type="button" class="btn btn-info btn-raised">Buy Now</button>
											</div>
										</div>
										<div class="col-sm-4">
											<div class="plan highlight">
												<div class="plan-heading">
													<header>Stardard</header>
												</div>  
												<ul class="features-list">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Style 2</h2>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="pricing-tables pricing-tables-style-2">
									<div class="row">
										<div class="col-sm-4">
											<div class="plan">
												<div class="plan-heading">
													<header>Free Package</header>
												</div>  
												<ul class="features-list">
													<li><strong>200GB</strong> Disk Space</li>
										...
										<div class="col-sm-4">
											<div class="plan highlight">
												<div class="plan-heading">
													<header>Premium Package</header>
												</div>  
												<ul class="features-list">
													<li><strong>5TB</strong> Disk Space</li>
													<li><strong>8GB</strong> RAM</li>
													<li><strong>1TB</strong> Bandwidth</li>
													<li><strong>100</strong> Email Addresses</li>
													<li class="text-danger"><strong>Unlimited</strong> Domains </li>
													<li class="text-danger"><strong>24/7</strong> Support</li>
												</ul>
												<div class="price layout-align-center-start layout-row">
													<div class="currency">$</div>
													<div class="layout-align-center-end layout-row">
										...
										<div class="col-sm-4">
											<div class="plan">
												<div class="plan-heading">
													<header>Exclusive Package</header>
												</div>  
												<ul class="features-list">
													<li><strong>10TB</strong> Disk Space</li>
