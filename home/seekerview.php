...
if($conn->connect_error)
{
  ...
  header("Content-Type:application/json");
    ...
    die("Connection Failed".$conn->connect_error);
       ...
       $userid=$_GET['id'];
       $query="SELECT * FROM seekers WHERE userid='".$userid."'";
       ...
       while($row=mysqli_fetch_array($res))
       {
          ...
          echo "<br><b>Email:</b>".$row['email']."<br><a  href='#message' class='modal-trigger'>Message him/her</a></p><h3>Skillset</h3>";
       }
       

       echo '<ul class="collection with-header" id="skillheader">';
      
         
        
         $res=mysqli_query($conn,"select * from `skills` WHERE `userid`='".$userid."'");
...
<div id="message" class="modal modal-fixed-footer">
    <div class="modal-content">
      <h4>Send message to <?php echo $name; ?></h4>
      <p>
      <select id="file" style="display:block">
      <option value="" disabled selected>Choose a file to attach link</option>
      <?php
    ...
    <div class="input-field col s12 l10 offset-l1">
              <textarea id="msg" name="msg" class="materialize-textarea" placeholder="HTML Message :)" required></textarea>
